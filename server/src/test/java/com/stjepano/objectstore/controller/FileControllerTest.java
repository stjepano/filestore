...
public class FileControllerTest {
    ...
    public void testDeleteFile() throws Exception {
        ...
        mockMvc.perform(delete("/bucket/fileA.png"))
                .andExpect(status().isOk());
    ...
    public void testDeleteFile_InvalidBucketName() throws Exception {
        mockMvc.perform(delete("/.\\..\\..\\someDir/sensitive_data"))
                .andExpect(status().isBadRequest());
    }
    ...
    public void testDeleteFile_InvalidFileName() throws Exception {
        mockMvc.perform(delete("/bucket/fileA\\..\\..\\shadow.png"))
                .andExpect(status().isBadRequest());
    }
    ...
    public void testUploadFile() throws Exception {
        ...
        mockMvc.perform(fileUpload("/bucket/").file(file))
                .andExpect(status().isOk());
    ...
    public void testUploadFile_DifferentFilename() throws Exception {
        ...
        mockMvc.perform(fileUpload("/bucket/?filename=something.png").file(file))
                .andExpect(status().isOk());
    ...
    public void testUploadFile__DifferentFileName_InvalidFileName() throws Exception {
        MockMultipartFile file = new MockMultipartFile("file", "fileA.png", "image/png", "abcd".getBytes());
        mockMvc.perform(fileUpload("/bucket/?filename=..\\..\\something.php").file(file))
                .andExpect(status().isBadRequest());
    }
    ...
    public void testOverwriteFile() throws Exception {
        ...
        mockMvc.perform(fileUpload("/bucket/fileA.png").file(file).with(request -> { request.setMethod("PUT"); return request; }))
                .andExpect(status().isOk());
    ...
    public void testDownloadFile() throws Exception {
        ...
        mockMvc.perform(get("/bucket/fileA.png"))
                .andExpect(status().isOk())
    ...
    public void testDownloadFile_NotAttachment() throws Exception {
        ...
        mockMvc.perform(get("/bucket/fileA.png?att=false"))
                .andExpect(status().isOk())
                .andExpect(content().bytes(bytes))
